...
- *2025.05*: We release 🌐Time-o1, a plugin-and-play approach for enhancing time-series direct forecast performance! See more [details](https://arxiv.org/abs/2505.17847).
...
- `TAI 2025` [DeepFilter: A Transformer-style Framework for Accurate and Efficient Process Monitoring](https://ieeexplore.ieee.org/document/11329174), **Hao Wang**, Zhichao Chen, Licheng Pan, Xiaoyu Jiang, Yichen Song, Qunshan He, Xinggao Liu.
...
- `NeurIPS 2025` [Towards accurate time series forecasting via implicit decoding](https://neurips.cc/virtual/2025/loc/san-diego/poster/116698), Xinyu Li, Yuchen Luo, **Hao Wang**, Haoxuan Li, Liuhua Peng, Feng Liu, Yandong Guo, Kun Zhang, Mingming Gong
...
- `WWW 2024` [A data-centric multi-objective learning framework for responsible recommendationsSystems](https://dl.acm.org/doi/abs/10.1145/3589334.3645324), Xu Huang, Jianxun Lian, **Hao Wang**, Hao Liao, Defu Lian, Xing Xie.
...
- `NeurIPS 2025` [Iterative Missing Data Imputation with Model Form Adaptation and Non-Missing Feature Supervision](https://openreview.net/attachment?id=L84DdFuvwV&name=pdf), **Hao Wang**, Zhengnan Li, Zhichao Chen, Xu Chen, Shuting He, Guangyi Liu, Haoxuan Li, Zhouchen Lin
...
- `JAS 2026` FMT-I: Flexible Mass Transport for Noise-Resilient Missing Data Imputation, **Hao Wang**, Licheng Pan, Yuan Lu, Shuting He, Xiaoyu Jiang, Zhichao Chen, Xinggao Liu.
